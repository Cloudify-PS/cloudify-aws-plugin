...
class TestEBS(testtools.TestCase):
    ...
    def test_attach_external_volume_or_instance(self):
        ...
        output = \
            test_volumeinstanceconn._attach_external_volume_or_instance(
                    BAD_INSTANCE_ID)
    ...
    def test_detach_external_volume_or_instance(self):
        ...
        output = \
            test_volumeinstanceconn._detach_external_volume_or_instance()
    ...
    def test_get_all_volumes_bad(self):
        ...
        output = test_volume._get_volumes([BAD_VOLUME_ID])
